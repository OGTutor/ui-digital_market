						...
						{isMounted && items.length === 0 ? (
							...
							>
								<div
									...
									h-40 w-40 text-muted-foreground"
								>
									<Image
										src="/empty-shopping-basket.png"
										fill
										loading="eager"
										alt="empty shopping cart ui digital market"
									/>
								</div>
