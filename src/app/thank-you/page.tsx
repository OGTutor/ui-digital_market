...
const ThankYouPage: FC<ThankYouPageProps> = async ({ searchParams }) => {
	...
	return (
		<main className="relative lg:min-h-full">
			<div
				...
				overflow-hidden lg:absolute
				lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12"
			>
				<Image
					fill
			...
			<div>
				<div
					...
					py-16 sm:px-6 sm:py-24 lg:grid
					lg:max-w-7xl lg:grid-cols-2
					lg:gap-x-8 lg:px-8 lg:py-32
					xl:gap-x-24"
				>
